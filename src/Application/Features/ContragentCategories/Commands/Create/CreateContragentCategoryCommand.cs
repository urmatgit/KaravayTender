...
{
    public class CreateContragentCategoryCommand: ContragentCategoryDto,IRequest<Result<int>>, IMapFrom<ContragentCategory>
    {
    ...
    public class CreateContragentCategoryCommandHandler : IRequestHandler<CreateContragentCategoryCommand, Result<int>>
    {
        ...
        public async Task<Result<int>> Handle(CreateContragentCategoryCommand request, CancellationToken cancellationToken)
        {
